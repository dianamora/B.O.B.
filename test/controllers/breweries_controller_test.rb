...
class BreweriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post breweries_url, params: { brewery: { hours: @brewery.hours, img_url: @brewery.img_url, location: @brewery.location, name: @brewery.name, phone_number: @brewery.phone_number } }, as: :json
    end
  ...
  test "should update brewery" do
    patch brewery_url(@brewery), params: { brewery: { hours: @brewery.hours, img_url: @brewery.img_url, location: @brewery.location, name: @brewery.name, phone_number: @brewery.phone_number } }, as: :json
    assert_response 200
  end
